...
class DQNAgent:
    ...
    def __init__(self):
        ...
        self.savepath = "/home/samarthmc/Pycar-lane-changing/model/"
        # Summary Writer
    ...
    def run(self):
        ...
        :return:
        """
        self.policy_model.load_state_dict(torch.load(self.savepath+"policy_epoch950.pth"))
        self.target_model.load_state_dict(torch.load(self.savepath+"target_epoch950.pth"))
        try:
            self.validate()
